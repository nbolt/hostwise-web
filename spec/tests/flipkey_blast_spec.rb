...
run do
  ...
  location = URI.unescape 'Los Angeles, California, USA'
      ...
      result_hash.each do |key, value|
        ...
        begin
          ...
          unless test
            ...
            sleep 3
            confirmation = @driver.find_element(:xpath, '//div[@id="inquiry-confirmation-modal"]//p[@class="inquiry-sent"]') rescue nil
