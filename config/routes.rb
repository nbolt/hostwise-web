Rails.application.routes.draw do
  ...
  scope module: 'host', constraints: { subdomain: 'host' } do
    ...
    get   '/transactions/booking/:id' => 'transactions#booking'
    get   '/transactions/property/:id' => 'transactions#property'
  ...
  scope module: 'contractor', constraints: { subdomain: 'contractor' } do
    ...
    post  '/users/:id/activated' => 'users#activated'
  ...
  scope module: 'admin', constraints: { subdomain: 'admin' } do
    ...
    get   '/contractors/export' => 'contractors#export'
    ...
    get   '/properties/export' => 'properties#export'
    ...
    get   '/coupons/export' => 'coupons#export'
