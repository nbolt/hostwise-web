describe('hostwise', function(){
  ...
  describe('booking flow:', function(){
    it('can book successfully', function(){
      ...
      browser.waitForAngular()
      $('.content-group.step-three .foot .right .button').click()
      browser.waitForAngular()
      $('.content-group.step-four .payment-tab.active #card-number').sendKeys('4242424242424242')
      $('.content-group.step-four .payment-tab.active #expiry-date').sendKeys('11/20')
      $('.content-group.step-four .payment-tab.active #cv-code').sendKeys('123')
      $('.content-group.step-four .foot .right .button').click()
      browser.driver.sleep(750)
      browser.waitForAngular()
