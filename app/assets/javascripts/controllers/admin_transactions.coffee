AdminTransactionsCtrl = ['$scope', '$http', '$timeout', '$window', 'spinner', 'ngDialog', ($scope, $http, $timeout, $window, spinner, ngDialog) ->
  ...
  $scope.fetch_bookings = ->
    table = angular.element("#example-1").dataTable({
      ...
      aoColumns: [{bSortable:false},null,null,null,null,{bSortable:false},{bSortable:false},{bSortable:false},{bSortable:false},{bSortable:false},{bSortable:false},{bSortable:false}]
      serverSide: true
      fnInitComplete: (->
