class Booking < ActiveRecord::Base
  ...
  def cost
    total_cost = ((adjusted_cost*100) + (contractor_service_cost*100) + (linen_cost*100) + (toiletries_cost*100) + (late_next_day_cost*100) + (late_same_day_cost*100) + (no_access_fee_cost*100) + (extra_king_sets_cost*100) + (extra_twin_sets_cost*100) + (extra_toiletry_sets_cost*100) - (first_booking_discount_cost*100) - coupon_cost) / 100.0
